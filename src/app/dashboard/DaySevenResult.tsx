    ...
    return (
        <div className="w-full animate-fade-in relative z-10 py-8">
            ...
            <div className="text-center mb-20 space-y-6">
                <h2 className="text-5xl md:text-7xl font-normal text-[#E6F0FF] tracking-tighter opacity-95 drop-shadow-sm">
                    El reseteo ha concluido
                </h2>
                <p className="text-slate-200 text-xl md:text-2xl font-normal leading-relaxed max-w-2xl mx-auto">
            ...
            <div className="mb-16 text-center max-w-3xl mx-auto px-6">
                <p className="text-slate-200 leading-[1.7] text-xl md:text-2xl font-normal italic opacity-90">
                    {summary}
                </p>
            </div>
            ...
            <div className="bg-[#19325a]/60 rounded-[40px] p-12 md:p-16 border border-blue-400/20 mb-20 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] backdrop-blur-xl text-center relative overflow-hidden group">
                ...
                <p className="text-[#E6F0FF] italic font-normal text-2xl md:text-3xl leading-[1.6] opacity-95 relative z-10">
            ...
            <div className="text-center space-y-12 max-w-2xl mx-auto border-t border-[#1a365d]/50 pt-20">
                ...
                <div className="flex flex-col gap-6 mt-12 items-center">
                    <Link href="/membership" className="inline-block px-12 py-5 bg-blue-600/20 hover:bg-blue-600/30 text-[#E6F0FF] border border-blue-400/30 rounded-full transition-all duration-700 font-normal tracking-widest shadow-[0_15px_40px_-10px_rgba(59,130,246,0.3)] hover:shadow-[0_20px_50px_-10px_rgba(59,130,246,0.5)] hover:-translate-y-1 backdrop-blur-md w-full sm:w-auto text-xl text-center uppercase tracking-[0.2em] text-xs">
                        Explorar Blue Wellness
                    </Link>
                    <Link href="/dashboard?day=1" className="text-xs uppercase tracking-[0.4em] text-slate-300 hover:text-[#E6F0FF] transition-colors py-4">
