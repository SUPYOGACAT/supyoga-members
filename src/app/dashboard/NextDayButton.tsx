...
export default function NextDayButton() {
    ...
    return (
        <button
            ...
            disabled={isLoading}
            className="group relative px-10 py-4 bg-blue-600/20 hover:bg-blue-600/30 text-[#E6F0FF] border border-blue-400/30 rounded-full transition-all duration-500 font-normal tracking-[0.3em] uppercase text-xs shadow-lg shadow-blue-900/10 hover:shadow-blue-500/10 disabled:opacity-20 flex items-center gap-3 active:scale-95"
        >
            {isLoading ? (
